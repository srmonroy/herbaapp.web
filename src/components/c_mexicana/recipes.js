...
const posts = [
  {
    title: 'Tacos de suadero-soya y pastor-tofu',
  ...
  {
    title: 'Tlacoyos de frijol/Haba con champiñones',
    href: '/platillos/contacto',
    category: { name: 'Ver Receta', href: '#' },
  ...
  },
  {
    ...
    href: '/platillos/contacto',
    category: { name: 'Ver Receta', href: '#' },
    description: 'Nuestro tofu a la mexicana está preparado con trozos de tofu marinado y salteado con tomate, cebolla y chile, ademas de pimenton y espinacas, sazonado con especias.',
    imageUrl: gfreeImage,
  },
];
    ...
    <div className="relative bg-blue-botton px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28 rounded-b-xl">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          <h2 className="text-4xl font-bold tracking-tight text-gray-900">Cocina mexica con enfoque alternativo</h2>
